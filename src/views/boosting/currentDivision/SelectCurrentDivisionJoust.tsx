...
import {divisionsJoust, tiers} from "./currentDivisionUtils";

import "../BoostingViewStyles.scss";

const SelectCurrentDivisionJoust = (props: SelectionProps) => {
    const {
      valuesFormBoosting,
      handleChange,
      nextStep,
    ...
    const divisionChoose = divisionsJoust.map((division) => (
...
export default SelectCurrentDivisionJoust;
